...
* The original package name 'com.example.spring-cloud-loadbalancer-user' is invalid and this project uses 'com.example.spring_cloud_loadbalancer_user' instead.
